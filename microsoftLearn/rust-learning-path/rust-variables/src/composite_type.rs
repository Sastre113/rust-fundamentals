...
fn car_quality(miles: u32) -> (Age, u32) {
    ...
    // return quality; // Como lo he hecho yo
    
    // best way: No need for "return" keyword or semicolon
    quality
}
...
fn main() {
    ...
    let colorsWithoutFrom = ["Blue","Green","Red","Silver"];

    // Declare the car type and initial values
    let mut car: Car = car_factory(colors[0].to_string(), Transmission::Automatic, true, 100);
    ...
    car = car_factory(colors[1].to_string(), engine, true, 200);
